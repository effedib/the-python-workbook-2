...
# the positives. Within each group the numbers should be displayed in the same order that they were entered.
...
# loop the question until blank is entered to fill the lists
while num != '':
    num = int(num)
    if num < 0:
